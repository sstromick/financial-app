    ...
    <section class="section pb-4">
        <div class="grid-container mt-2">
            <div class="text-center flex-column flex-center">
                ...
                <h1 class="text-secondary text-28 weight-500">Monthly Other Income</h1>
                ...
                <div class="mt-2">
                    ...
                    >
                        ...
                        <p class="font-book text-25 mb-4">
                            Below, enter in the amount of your other income. If
                            you don’t know the exact number, that’s okay! Enter
                            your best estimate.
                        </p>
            ...
            >
                ...
                >
                    ...
                    >
                        <input
                            name="other_income"
                            v-model="submission.other_income"
                            placeholder="XXXXXX"
                            type="number"
                            step="0.01"
                            min="1"
...
export default {
    ...
    data: function() {
        return {
            ...
            // substeps: this.$store.getters.getSubsteps,
        };
    },
    computed: {},
    methods: {
        onSubmit($event) {
            if (this.submission.other_income) {
                this.$store.dispatch(
                ...
                this.message =
                    "You must enter the estimated amount of other income you receive.";
            }
        }
    },
    mounted() {
        let income_type = this.income_types.filter(obj => {
            return obj.income_type === "Other Income";
        });
