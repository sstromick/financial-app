                ...
                <div class="mt-2">
                    ...
                    >
                        ...
                        <p class="font-book text-25 mb-4">
                            Below, enter in the amount of your retirement
                ...
                >
                    ...
                    >
                        <input
                            ...
                            v-model="submission.retirement_income"
                            placeholder="XXXXXX"
                            type="number"
                            step="0.01"
                            min="1"
...
export default {
    ...
    methods: {
        async onSubmit($event) {
            ...
            if (this.submission.retirement_income && isValid) {
                this.$store.dispatch(
                ...
                this.message =
                    "You must enter the estimated amount of retirement income you receive.";
            }
        }
    },
    mounted() {
        let income_type = this.income_types.filter(obj => {
            return obj.income_type === "Retirement Income";
        });
