                ...
                <div class="mt-2">
                    ...
                    >
                        ...
                        <p class="font-book text-25 mb-4">
                            Below, enter in the amount of your self employment
                ...
                >
                    ...
                    >
                        <input
                            ...
                            v-model="submission.self_employment_income"
                            placeholder="XXXXXX"
                            step="0.01"
                            min="1"
                            type="number"
...
export default {
    ...
    methods: {
        async onSubmit($event) {
            ...
            if (this.submission.self_employment_income && isValid) {
                this.$store.dispatch(
                ...
                this.message =
                    "You must enter the estimated amount of self employment income you receive.";
            }
        }
    },
    mounted() {
        let income_type = this.income_types.filter(obj => {
            return obj.income_type === "Self-Employment Income";
        });
